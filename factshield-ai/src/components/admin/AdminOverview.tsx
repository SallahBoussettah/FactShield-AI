...
import FlaggedContentBadge from './FlaggedContentBadge';
...
const AdminOverview: React.FC = () => {
  ...
  // Handler for navigating to content moderation
  const handleGoToContentModeration = () => {
    navigate('/admin', { state: { section: 'content' } });
  };
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="flex flex-col items-center">
            <FlaggedContentBadge 
              count={mockStats.contentReviewQueue} 
              onClick={handleGoToContentModeration} 
            />
          </div>
